...
| **参数** | **类型** | **是否必选** | **示例** | **描述** |
| --- | --- | --- | --- | --- |
| url | string | 是 | [https://static.openxlab.org.cn/](https://static.openxlab.org.cn/)opendatalab/pdf/demo.pdf | 文件 URL，支持.pdf、.doc、.docx、.ppt、.pptx、.png、.jpg、.jpeg、.html多种格式 |
...
| language | string | 否 | ch | 指定文档语言，默认 ch，其他可选值列表详见：[https://www.paddleocr.ai/latest/version3.x/algorithm/PP-OCRv5/PP-OCRv5_multi_languages.html#_3](https://www.paddleocr.ai/latest/version3.x/algorithm/PP-OCRv5/PP-OCRv5_multi_languages.html#_3)，仅对pipeline模型且非html文件有效 |
...
| data.full_zip_url | string | [https://cdn-mineru.openxlab.org.cn/](https://cdn-mineru.openxlab.org.cn/)pdf/018e53ad-d4f1-475d-b380-36bf24db9914.zip | 文件解析结果压缩包，文件详细说明请参考：[https://opendatalab.github.io/MinerU/reference/output_files/](https://opendatalab.github.io/MinerU/reference/output_files/) |
